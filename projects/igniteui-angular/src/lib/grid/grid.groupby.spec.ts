...
describe('IgxGrid - GroupBy', () => {
    ...
    it('should reorder groups when reordering chip', async () => {
        ...
        await UIInteractions.simulatePointerEvent('pointerdown', chipComponents[0].componentInstance.dragDir.element.nativeElement, 75, 30);
        // tslint:disable-next-line:max-line-length
        await UIInteractions.simulatePointerEvent('pointermove', chipComponents[0].componentInstance.dragDir.element.nativeElement, 110, 30);
        fix.detectChanges();
