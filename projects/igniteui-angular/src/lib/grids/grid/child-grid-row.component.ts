...
export class IgxChildGridRowComponent implements DoCheck {
    ...
    constructor(public gridAPI: GridBaseAPIService<IgxGridComponent>,
    ...
    public toggle() {
        ...
        if (this.expanded) {
            //this.gridAPI.get(this.grid.id).hierarchicalState.push({rowID: this.rowID});
        }
        //this.grid.reflow();
    }
