...
export class SampleTestData {
    ...
    public static employeePrimaryForeignKeyTreeData = () => ([
        ...
        { ID: 5, ParentID: 8, Name: 'Celia Martinez', JobTitle: 'Senior Software DEVELOPER', Age: 50 },
        { ID: 6, ParentID: -1, Name: 'Erma Walsh', JobTitle: 'CEO', Age: 52 },
        { ID: 7, ParentID: 2, Name: 'Debra Morton', JobTitle: 'Associate Software Developer', Age: 35 },
        { ID: 8, ParentID: 8, Name: 'Erika Wells', JobTitle: 'Software Development Team Lead', Age: 28 },
